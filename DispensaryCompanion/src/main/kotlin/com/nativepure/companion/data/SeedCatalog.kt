...
object SeedCatalog {
    val products = listOf(
        Product("fl-dusk", "Dusk Bloom", "Solstice Farms", ProductCategory.FLOWER, StrainType.INDICA, 24.5, 0.4, 45.0, "3.5g", "Dense purple-tipped buds with berry and cedar notes. Evening wind-down favorite.", "Relaxed · Sleepy · Calm", featured = true, stockQuantity = 24, sku = "SOL-FL-DUSK"),
        ...
        Product("pr-twilight", "Twilight Pack", "Solstice Farms", ProductCategory.PREROLL, StrainType.INDICA, 23.0, 0.4, 28.0, "5-pack", "Ready-to-light evening pre-rolls packed with Dusk Bloom flower.", "Relaxed · Sleepy", featured = true, stockQuantity = 30, sku = "SOL-PR-TWIL"),
        ...
        Product("ed-cocoa", "Midnight Cocoa", "Hearth Kitchen", ProductCategory.EDIBLE, StrainType.HYBRID, 0.0, 0.0, 24.0, "10x10mg", "Dark chocolate squares with a slow, steady onset. Dose clearly marked.", "Relaxed · Euphoric", featured = true, stockQuantity = 22, sku = "HK-ED-COCO"),
        ...
        Product("vp-cart", "Solstice Cart — Sage", "Solstice Farms", ProductCategory.VAPE, StrainType.HYBRID, 85.0, 0.5, 38.0, "0.5g", "Ceramic cart with herbal and citrus terps. Discreet and consistent.", "Balanced · Smooth", featured = true, stockQuantity = 14, sku = "SOL-VP-SAGE"),
