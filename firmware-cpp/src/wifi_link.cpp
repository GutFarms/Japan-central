...
void WifiLink::beacon() {
  ...
  char msg[220];
#if CYD_D0_BUILD
  static constexpr const char* kFwTag = "0.8.127-sha256-d0";
  static constexpr const char* kFwShort = "0.8.127-d0";
#else
  static constexpr const char* kFwTag = "0.8.127-sha256";
  static constexpr const char* kFwShort = "0.8.127";
#endif
