...
!define MUI_WELCOMEPAGE_TEXT "Install the Windows app that configures your ESP32-2432S028 SHA-256 Bitcoin miner over USB.$\r$\n$\r$\nAfter install: plug USB → Connect → Connect → Start mining."
