...
echo "       nano $ROOT/.env"
echo "     or: agent login"
echo "  2) Desktop control panel (settings / dark mode / offline):"
echo "       $ROOT/scripts/run-gui.sh"
echo "  3) Foreground worker test:"
echo "       $ROOT/scripts/start-worker.sh"
echo "  4) Or install as a boot service:"
echo "       sudo $ROOT/scripts/install_service.sh"
echo "  5) Pick \"cursor-appliance\" on https://cursor.com/agents"
echo
