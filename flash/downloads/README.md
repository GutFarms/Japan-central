# Njörðr Seas' CYD miner downloads (`0.8.57`)
...
Firmware: [merged.bin](./esp32-2432s028-sha256-miner-merged.bin) @ `0x0` · [d0-merged.bin](./esp32-2432s028-sha256-miner-d0-merged.bin) · [SHA256SUMS.txt](./SHA256SUMS.txt) · [VERSION.txt](./VERSION.txt)
